...
const schema = yup.object().shape({
  ...
  export default function SignupOper() {
    ...
    async function createUser(schema) {
      await createUserWithEmailAndPassword(auth1, schema.email, schema.password, schema.confirmarSenha, schema.username, "Operador")
        .then(() => {
